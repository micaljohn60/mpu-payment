...
<div style="display:none;">
	...
	<a href="https://www.mpuecomuat.com:60145/UAT/Payment/Action/api?merchantID= <?php echo "201104000003541" ?> tranRef= <?php echo $tranRef ?> actionType=I hashValue=" <?php echo $hashValue ?> ">" Hello</a>
	      <table>
	<tr>
		<td>Merchant ID</td>
		<td>:</td>
