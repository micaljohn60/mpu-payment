...
<form id="payment_form" action="payment_confirmation.php" method="post">
 ...
 <input type="hidden" name="user_name" value="<?php echo $name; ?>">
    ...
    <input type="hidden" name="signed_field_names" value="access_key,profile_id,transaction_uuid,signed_field_names,unsigned_field_names,signed_date_time,locale,transaction_type,reference_number,amount,currency,line_item_count,item_1_name,item_2_code,item_3_quantity">
<input type="hidden" name="unsigned_field_names" value="line_item_count,item_1_name,item_2_code,item_3_quantity">
