...
<div style="display:none;">
	<Form method="post" action="https://www.mpuecomuat.com:60145/UAT/Payment/Action/api</php"merchantID="$marchandID+"%20&%20tranRef="$tranRef+"&actionType=I"+"&hashValue="$hashValue ?>"> 
	<table>
	<tr>
		<td>Merchant ID</td>
		<td>:</td>
