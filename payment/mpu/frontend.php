...
<h1 style="text-align:center;margin-top: 200px;font-size: 50px;"><?php if (empty($dateTime)) 
{
    echo "Your order is not complete!" ;
    echo  $userDefined1;
} 
    else 
    {
...
<table>
	...
	<tr>
		...
		<th><span>-</span></th>
		<th><span> <?php echo $userDefined3; ?></span></span></th>
	</tr>
	
	<tr>
		<td><span>Name</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $userDefined1; ?></td>
	</tr>
	<tr>
		<td><span>Phone No.</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $userDefined2; ?></span></td>
	</tr>
	
    <tr>
		<td><span>Amount</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $payamount; ?></td>
	</tr>
	<tr>
		<td><span>Card No.</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $pan; ?></td>
	</tr>
	
	<tr>
		<td><span>Status</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $status; ?></td>
	</tr>
	
	<tr>
		<td><span>Transaction Reference</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $tranRef; ?></td>
	</tr>
	<tr>
		<td><span>DateTime</span></td>
		<td><span>-</span></td>
		<td><span><?php echo $dateTime; ?></td>
	</tr>
